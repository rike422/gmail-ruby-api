...
module Gmail
  class ThreadTest < Test::Unit::TestCase
    ...
    should 'Thread should be deletable' do
      @mock.expects(:execute).with(
        api_method: Gmail.service.users.threads.delete,
        parameters: {
          userId: 'me',
          id: test_thread[:id]
        },
    ...
    should 'Thread should be thrashable' do
      @mock.expects(:execute).with(
        api_method: Gmail.service.users.threads.trash,
        parameters: {
          userId: 'me',
          id: test_thread[:id]
        },
    ...
    should 'Thread should be unthrashable' do
      @mock.expects(:execute).with(
        api_method: Gmail.service.users.threads.untrash,
        parameters: {
          userId: 'me',
          id: test_thread[:id]
        },
    ...
    context 'Modifying Labels' do
      should 'Thread should be starrable' do
        @mock.expects(:execute).with(
          api_method: Gmail.service.users.threads.modify,
          parameters: {
            userId: 'me',
            id: test_thread[:id]
          },
          ...
          headers: { 'Content-Type' => 'application/json' }
        ).twice.returns(test_response(test_thread))
        t = Gmail::Thread.new(test_thread)
        r = t.star
        assert_equal Gmail::Thread, r.class
